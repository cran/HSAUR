...
special meaning in formulae as will be explained in Chapter~\ref{ANOVA}, the
...
fit (see Chapter~\ref{MLR}) for mortality on hardness.
...
We add a least squares fit (see Chapter~\ref{MLR}) to the scatterplot and,
