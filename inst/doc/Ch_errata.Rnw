...
The names of the test statistics in the output have been changed from \Rcmd{T} to \Rcmd{Z}
...
Page 121: small numeric differences for the output of \Rcmd{optim}
\section{Recursive Partitioning}
Page 139: small differences in \Rcmd{predtab}
...
--nothing known--
\section*{Thanks}
We would like to thank the following people for pointing our errors, typos etc and for
